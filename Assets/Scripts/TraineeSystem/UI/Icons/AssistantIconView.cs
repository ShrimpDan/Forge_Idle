...
public class AssistantIconView : MonoBehaviour
{
    ...
    public TraineeData Data => data;

    public void Init(TraineeData trainee, Action onClickCallback)
    {
        data = trainee;
        onClick = onClickCallback;

        nameText.text = trainee.Name;
        specializationText.text = GetKoreanSpecialization(trainee.Specialization);
