...
/// </summary>
public class AssistantCardSpawner
{
    ...
    private readonly AssistantFactory factory;
    private readonly AssistantDrawController drawController;

    public AssistantCardSpawner(
        ...
        AssistantDrawController drawController)
    {
    ...
    AssistantInstance data,
    Transform parentOverride = null,
    System.Action<AssistantInstance> onConfirmAction = null,
    ...
    /// 미니 카드 프리팹을 생성합니다.
    /// </summary>
    public GameObject SpawnMiniCard(AssistantInstance data, int index)
    {
    ...
    private void SetupCard(
        ...
        bool playSpawnEffect = true)
    {
        var controller = obj.GetComponent<AssistantController>();
        if (controller == null)
        {
            Object.Destroy(obj);
            return;
